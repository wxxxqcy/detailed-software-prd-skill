...
description: 将产品构想、业务需求、会议纪要、功能清单或现有系统说明转化为非常详细、可开发、可测试、可验收的软件需求文档（PRD/SRS）。支持完整PRD、单模块、单页面、PRD审查、需求变更影响分析；使用 Mermaid 绘制架构/流程/状态/ER 图，使用 ASCII Wireframe 绘制页面/弹窗/状态原型，并生成字段、按钮、权限、业务规则、异常和 Given/When/Then 验收标准。
---
